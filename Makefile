...
test_execute:
	iverilog -I src -o execute_tb.out test/execute_tb.v src/memtypes.v src/execute.v
	./execute_tb.out
	gtkwave execute_tb.vcd test/execute_tb.gtkw

test_mem_dff:
	iverilog -I src -o mem_dff_tb.out test/mem_dff_tb.v src/memtypes.v src/mem_dff.v
	./mem_dff_tb.out
