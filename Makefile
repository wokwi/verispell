...
test_mem_dff:
	iverilog -I src -o mem_dff_tb.out test/mem_dff_tb.v src/mem_dff.v
	./mem_dff_tb.out
	gtkwave mem_dff_tb.vcd test/mem_dff_tb.gtkw

test_spell:
	iverilog -I src -s spell -s dump -o spell_test.out src/spell.v src/mem_dff.v src/execute.v test/dump_spell.v
